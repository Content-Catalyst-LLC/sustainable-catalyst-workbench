...
final class SCWB_V301_Production_Reliability {
    ...
    public static function studio_catalog() {
        return array(
            ...
            'prototype-bench' => array('label' => 'Physical Prototype Bench', 'shortcode' => 'sc_workbench_prototype_bench', 'description' => 'Arduino, ESP32, Raspberry Pi, PYNQ, Verilog, and VHDL export scaffolds connecting mathematical signals to bounded physical-computing prototypes.'),
            'graph-mathematics' => array('label' => 'Graph Mathematics', 'shortcode' => 'sc_workbench_graph_mathematics', 'description' => 'Advanced graph mathematics with multi-expression stacks, domain-restricted piecewise views, linked parameters, roots, extrema, intersections, tangent/normal construction, asymptotes, discontinuities, value tables, vector fields, and 3D surfaces.'),
            'geometry' => array('label' => 'Dynamic Geometry', 'shortcode' => 'sc_workbench_dynamic_geometry', 'description' => 'Interactive points, lines, circles, polygons, conics, constraints, measurements, affine transformations, algebra-geometry linkage, and expression-driven loci.'),
            'numerical' => array('label' => 'Numerical Computing', 'shortcode' => 'sc_workbench_numerical_methods', 'description' => 'Root finding, numerical integration and differentiation, interpolation, ODE solvers, linear algebra, least squares, and bounded optimization with inspectable diagnostics.'),
            'signals' => array('label' => 'Signals & Control Mathematics', 'shortcode' => 'sc_workbench_signals_systems_controls', 'description' => 'FFT spectra, digital filter design, transfer functions, Bode response, root locus, state-space controllability/observability, convolution, and PID closed-loop simulation.'),
            'electronics' => array('label' => 'Electronics & Embedded Systems', 'shortcode' => 'sc_workbench_electronics_embedded', 'description' => 'Circuit and impedance analysis, ADC/DAC quantization, PWM/timer planning, sampling, I²C/SPI/UART estimates, sensor models, GPIO allocation, and export-only MCU/FPGA scaffolds.'),
            'digital-logic' => array('label' => 'FPGA, PYNQ & Digital Logic', 'shortcode' => 'sc_workbench_digital_logic', 'description' => 'Boolean logic, truth tables, Karnaugh maps, minimization, finite-state machines, timing waveforms, resource estimates, Verilog/VHDL testbench scaffolds, and PYNQ overlay planning.'),
            ...
            'extensions' => array('label' => 'Extension SDK', 'shortcode' => 'sc_workbench_extension_sdk', 'description' => 'Capability-scoped manifests, compatibility reports, private registry entries, lifecycle plans, hook contracts, security audits, developer scaffolds, and portable extension packages.'),
            ...
            'fpga-electronics' => array('label' => 'Electronics & FPGA (Legacy)', 'shortcode' => 'sc_workbench_fpga_studio', 'description' => 'HDL, constraints, schematics, BOMs, PCB planning, and validation from the earlier hardware studio.'),
