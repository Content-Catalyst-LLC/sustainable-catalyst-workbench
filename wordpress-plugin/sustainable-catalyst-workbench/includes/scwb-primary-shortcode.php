<?php
/** Canonical Workbench v5.7.0 primary shortcode and studio router. */
if (!defined('ABSPATH')) {
    exit;
}
...
final class SCWB_Primary_Shortcode_Repair {
    ...
    private static function render_studio($studio, $project, $key) {
        if (!shortcode_exists($studio['shortcode'])) {
            return sprintf(
                '<div class="scwb-primary__module-error" role="alert"><strong>%s is unavailable.</strong><p>The shortcode <code>[%s]</code> is not registered. Install the complete Workbench v5.7.0 plugin and clear all caches.</p></div>',
    ...
    public static function render($atts = array()) {
        ...
        if (!$studios) {
            return '<div class="scwb-primary scwb-primary--error"><strong>Workbench registry is unavailable.</strong><p>Confirm that the complete v5.7.0 plugin is active.</p></div>';
        }
        ...
        if (!$available_keys) {
            return '<div class="scwb-primary scwb-primary--error"><strong>Workbench modules are unavailable.</strong><p>Install the complete v5.7.0 plugin rather than a partial add-on.</p></div>';
        }
        ...
        >
            ...
            <header class="scwb-primary__header">
                <div>
                    <p class="scwb-primary__eyebrow">Sustainable Catalyst Workbench v5.7.0</p>
            ...
            <?php if ($show_diagnostics) : ?>
                <details class="scwb-primary__diagnostics">
                    ...
                    <div class="scwb-primary__diagnostics-grid">
                        <div><strong>Primary shortcode</strong><span>Registered by v5.7.0</span></div>
