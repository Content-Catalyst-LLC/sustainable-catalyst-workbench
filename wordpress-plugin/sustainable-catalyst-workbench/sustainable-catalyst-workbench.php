...
require_once __DIR__ . '/includes/scwb-v830-research-asset-artifact-registry.php';

// Workbench v8.4.0 — Interactive Execution Console.
require_once __DIR__ . '/includes/scwb-v840-interactive-execution-console.php';

// Workbench v8.5.0 — Research Timeline & Run History.
require_once __DIR__ . '/includes/scwb-v850-research-timeline-run-history.php';

// Workbench v8.6.0 — Visual Research Canvas.
require_once __DIR__ . '/includes/scwb-v860-visual-research-canvas.php';

// Workbench v8.7.0 — Linked Scientific Views & Cross-Filtering.
require_once __DIR__ . '/includes/scwb-v870-linked-scientific-views.php';
...
// Workbench v8.12.0 — Research Publication & Evidence Handoff.
...
// Workbench v9.2.0 — Experimental Design & Research Protocol Builder.
require_once __DIR__ . '/includes/scwb-v910-experimental-design-research-protocol-builder.php';
...
require_once __DIR__ . '/includes/scwb-v980-cross-study-meta-analysis-workspace.php';
require_once __DIR__ . '/includes/scwb-v990-research-package-exchange-portability.php';

// Workbench v9.10.0 — Platform-Wide Scientific Research Handoff.
require_once __DIR__ . '/includes/scwb-v9100-platform-wide-scientific-research-handoff.php';

// Workbench v9.11.0 — End-to-End Research Study Certification.
require_once __DIR__ . '/includes/scwb-v9110-end-to-end-research-study-certification.php';

// Workbench v9.12.0 — Workbench v9 Production Certification.
require_once __DIR__ . '/includes/scwb-v9120-workbench-v9-production-certification.php';
