...
final class SC_Workbench_Plugin {
    ...
    private function code_studio_manifest() {
        ...
        return [
            ...
            'runtimes' => [
                ['id'=>'javascript', 'label'=>'JavaScript', 'target'=>'browser-worker', 'status'=>'available', 'version'=>'Browser ES', 'packages'=>['Workbench console','Workbench tables','Workbench chart specs'], 'release'=>'2.2.0'],
                ['id'=>'python', 'label'=>'Python', 'target'=>'pyodide-worker', 'status'=>'available', 'version'=>'Pyodide 314.0.2', 'packages'=>['Python standard library','NumPy','pandas','SciPy','SymPy','Matplotlib','scikit-learn','statsmodels'], 'release'=>'2.2.0'],
                ['id'=>'r', 'label'=>'R', 'target'=>'webr-worker', 'status'=>'available', 'version'=>'webR 0.6.0 / R 4.6.0', 'packages'=>['base','stats','graphics','grDevices','utils','datasets','methods'], 'release'=>'2.2.0'],
                ['id'=>'sql', 'label'=>'SQL', 'target'=>'duckdb-wasm', 'status'=>'available', 'version'=>'DuckDB-Wasm 1.30.0', 'packages'=>['CSV','JSON','window functions','analytical SQL'], 'release'=>'2.2.0'],
