# Workbench v5.0.0 local application
...
not simulated offline; team workspace records can be prepared and exported for
explicit import into an authenticated deployment.
