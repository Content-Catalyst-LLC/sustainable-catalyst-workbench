...
def test_v9100_identity_and_registration():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.12.0"' in main and 'from app.v9100 import router as v9100_router' in main
...
def test_v9100_wordpress_surface():
    ...
    main=(ROOT/'wordpress-plugin/sustainable-catalyst-workbench/sustainable-catalyst-workbench.php').read_text(); assert 'Version: 9.12.0' in main and "define('SCWB_VERSION', '9.12.0');" in main and 'scwb-v9100-platform-wide-scientific-research-handoff.php' in main
