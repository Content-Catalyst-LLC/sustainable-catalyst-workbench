...
def test_v8100_release_identity_and_routes():
    ...
    assert 'version="8.10.0"' in main and 'from app.v8100 import router as v8100_router' in main
    compose=(ROOT/'compose.yml').read_text()
    assert 'sustainable-catalyst-workbench:8.10.0' in compose and "d.get('version')=='8.10.0'" in compose and '127.0.0.1:8088:8088' in compose
