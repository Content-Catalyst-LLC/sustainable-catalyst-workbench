...
v310_marker($bootstrap, 'Version: 3.1.0', $failures);
v310_marker($bootstrap, "define('SCWB_VERSION', '3.1.0')", $failures);
...
v310_marker($primary, 'data-scwb-version="3.1.0"', $failures);
...
if ($failures) {
    fwrite(STDERR, "Workbench v3.1.0 activation audit failed:\n- " . implode("\n- ", $failures) . "\n");
    exit(1);
}
