...
require_marker($bootstrap, 'Version: 3.2.0', $failures);
require_marker($bootstrap, "define('SCWB_VERSION', '3.2.0')", $failures);
...
echo "Workbench v3.2.0 plugin activation audit passed for " . count($expected) . " studios.\n";
