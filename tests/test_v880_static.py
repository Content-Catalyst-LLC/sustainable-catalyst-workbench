...
def test_v880_release_identity_and_routes():
 ...
 main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.10.0"' in main and 'from app.v880 import router as v880_router' in main
...
def test_v880_artifacts_and_wp():
 ...
 main=(ROOT/'wordpress-plugin/sustainable-catalyst-workbench/sustainable-catalyst-workbench.php').read_text(); assert 'Version: 9.10.0' in main and "define('SCWB_VERSION', '9.10.0')" in main and 'scwb-v880-comparative-experiment-model-analysis.php' in main and 'SCWB_DIR' not in main
