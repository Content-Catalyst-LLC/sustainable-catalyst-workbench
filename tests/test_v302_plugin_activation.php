...
marker($plugin . '/sustainable-catalyst-workbench.php', 'Version: 3.0.2', $failures);
marker($plugin . '/sustainable-catalyst-workbench.php', "define('SCWB_VERSION', '3.0.2')", $failures);
...
if ($failures) { fwrite(STDERR, "Workbench v3.0.2 activation audit failed:\n- " . implode("\n- ", $failures) . "\n"); exit(1); }
echo "Workbench v3.0.2 activation audit passed.\n";
