...
$ok=(strpos($main,'Version: 5.9.0')!==false || (strpos($main,'Version: 6.0.0')!==false || strpos($main,'Version: 6.0.1')!==false))
    && (strpos($main,"define('SCWB_VERSION', '5.9.0')")!==false || (strpos($main,"define('SCWB_VERSION', '6.0.0')")!==false || strpos($main,"define('SCWB_VERSION', '6.0.1')")!==false))
    && strpos($main,'SCWB_V590_PLUGIN_FILE')!==false
    && strpos($php,"const VERSION = '5.9.0'")!==false
    && strpos($php,'sc_workbench_digital_logic')!==false
    && (strpos($primary,"const VERSION = '5.9.0'")!==false || (strpos($primary,"const VERSION = '6.0.0'")!==false || strpos($primary,"const VERSION = '6.0.1'")!==false))
    && (strpos($primary,'data-scwb-version="5.9.0"')!==false || (strpos($primary,'data-scwb-version="6.0.0"')!==false || strpos($primary,'data-scwb-version="6.0.1"')!==false))
