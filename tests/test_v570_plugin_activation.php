...
$ok=(strpos($main,'Version: 5.7.0')!==false || strpos($main,'Version: 5.8.0')!==false)
    && (strpos($main,"define('SCWB_VERSION', '5.7.0')")!==false || strpos($main,"define('SCWB_VERSION', '5.8.0')")!==false)
    ...
    && (strpos($primary,"const VERSION = '5.7.0'")!==false || strpos($primary,"const VERSION = '5.8.0'")!==false)
    && (strpos($primary,'data-scwb-version="5.7.0"')!==false || strpos($primary,'data-scwb-version="5.8.0"')!==false);
