...
def test_v980_identity_and_registration():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.9.0"' in main and 'from app.v980 import router as v980_router' in main
...
def test_v980_wordpress_surface():
    ...
    main=(ROOT/'wordpress-plugin/sustainable-catalyst-workbench/sustainable-catalyst-workbench.php').read_text(); assert 'Version: 9.9.0' in main and "define('SCWB_VERSION', '9.9.0');" in main and 'scwb-v980-cross-study-meta-analysis-workspace.php' in main
