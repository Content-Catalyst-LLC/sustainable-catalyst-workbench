...
def test_v950_identity_and_registration():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.9.0"' in main and 'from app.v950 import router as v950_router' in main
...
def test_v950_wordpress():
    ...
    assert 'Version: 9.9.0' in plugin and "define('SCWB_VERSION', '9.9.0')" in plugin and 'scwb-v950-model-calibration-parameter-estimation.php' in plugin
