...
const expected = ['unified','research','embedded','electronics','robotics','instrumentation','simulation','runtime','visualization','experiments','documentation'];
...
assert.strictEqual(router.version, '3.0.1');
...
assert.strictEqual(root.getAttribute('data-scwb-audit-count'), '11');
...
console.log(`Workbench v3.0.1 router regression passed for ${expected.length} studios.`);
