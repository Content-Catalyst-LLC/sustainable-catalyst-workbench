...
const expected = ['unified','research','embedded','electronics','robotics','instrumentation','simulation','runtime','visualization','experiments','documentation','recovery'];
...
assert.strictEqual(router.version, '3.0.2');
...
assert.strictEqual(root.getAttribute('data-scwb-audit-count'), '12');
...
console.log(`Workbench v3.0.2 router regression passed for ${expected.length} studios.`);
