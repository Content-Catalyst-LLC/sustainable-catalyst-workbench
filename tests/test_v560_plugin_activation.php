...
$ok=(strpos($main,'Version: 5.6.0')!==false || strpos($main,'Version: 5.7.0')!==false)
    && (strpos($main,"define('SCWB_VERSION', '5.6.0')")!==false || strpos($main,"define('SCWB_VERSION', '5.7.0')")!==false)
    ...
    && (strpos($primary,"const VERSION = '5.6.0'")!==false || strpos($primary,"const VERSION = '5.7.0'")!==false)
