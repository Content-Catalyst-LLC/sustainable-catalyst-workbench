...
def test_release_identity_and_registration():
    assert 'APP_VERSION = "6.12.0"' in (ROOT/'backend/app/release.py').read_text()
...
def test_wordpress_identity_and_include():
    ...
    assert 'Version: 6.12.0' in main and "define('SCWB_VERSION', '6.12.0')" in main and 'scwb-v6110-forensic-quantitative-reconstruction.php' in main
