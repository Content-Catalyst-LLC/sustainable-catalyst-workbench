...
must_contain_v390($plugin.'/sustainable-catalyst-workbench.php','Version: 3.9.0',$failures);
must_contain_v390($plugin.'/sustainable-catalyst-workbench.php',"define('SCWB_VERSION', '3.9.0')",$failures);
must_contain_v390($plugin.'/sustainable-catalyst-workbench.php','scwb-v390-production-hardening.php',$failures);
must_contain_v390($root.'/backend/app/main.py','version="3.9.0"',$failures);
...
if($failures){fwrite(STDERR,"Workbench v3.9.0 activation audit failed:\n- ".implode("\n- ",$failures)."\n");exit(1);}echo "Workbench v3.9.0 activation audit passed.\n";
