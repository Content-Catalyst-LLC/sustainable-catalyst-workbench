...
def test_v930_current_release_identity_and_registration():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.12.0"' in main and 'from app.v930 import router as v930_router' in main and 'app.include_router(v930_router)' in main
...
def test_v930_wordpress_surface_and_identity():
    ...
    assert 'Version: 9.12.0' in plugin and "define('SCWB_VERSION', '9.12.0')" in plugin and 'scwb-v930-statistical-analysis-diagnostic-workspace.php' in plugin
