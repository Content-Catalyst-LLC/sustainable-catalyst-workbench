...
def test_v780_identity_router_compose():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="8.0.0"' in main
...
def test_v780_wordpress():
    ...
    assert 'Version: 8.0.0' in main and "define('SCWB_VERSION', '8.0.0')" in main and 'SCWB_DIR' not in main
