...
def test_v940_identity_and_registration():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.10.0"' in main and 'from app.v940 import router as v940_router' in main
...
def test_v940_wordpress():
    ...
    assert 'Version: 9.10.0' in plugin and "define('SCWB_VERSION', '9.10.0')" in plugin and 'scwb-v940-uncertainty-sensitivity-study-composer.php' in plugin
