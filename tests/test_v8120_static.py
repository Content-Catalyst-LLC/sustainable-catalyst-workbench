...
def test_v8120_release_identity_and_routes():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.3.0"' in main and 'from app.v8120 import router as v8120_router' in main
...
def test_v8120_wordpress_and_boundary_contract():
    main=(ROOT/'wordpress-plugin/sustainable-catalyst-workbench/sustainable-catalyst-workbench.php').read_text(); assert 'Version: 9.3.0' in main and "define('SCWB_VERSION', '9.3.0')" in main and 'SCWB_DIR' not in main
