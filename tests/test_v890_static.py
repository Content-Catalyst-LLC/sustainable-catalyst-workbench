...
def test_v890_release_identity_and_routes():
    ...
    assert 'version="8.9.0"' in main and 'from app.v890 import router as v890_router' in main
    compose = (ROOT / 'compose.yml').read_text()
    assert 'sustainable-catalyst-workbench:8.9.0' in compose and "d.get('version')=='8.9.0'" in compose and '127.0.0.1:8088:8088' in compose
