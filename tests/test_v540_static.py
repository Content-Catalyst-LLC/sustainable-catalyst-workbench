...
def test_v540_backend_route_and_runtime_identity():
    ...
    assert 'version="5.4.0"' in main or 'version="5.5.0"' in main or 'version="5.6.0"' in main
    assert 'from app.v540 import router as v540_router' in main
    assert 'app.include_router(v540_router)' in main
    assert 'sustainable-catalyst-workbench:5.4.0' in compose or 'sustainable-catalyst-workbench:5.5.0' in compose or 'sustainable-catalyst-workbench:5.6.0' in compose
