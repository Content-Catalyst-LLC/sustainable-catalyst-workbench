...
def test_v960_identity_and_registration():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'version="9.7.0"' in main and 'from app.v960 import router as v960_router' in main
    assert 'sustainable-catalyst-workbench:9.7.0' in (ROOT/'compose.yml').read_text()
...
def test_v960_wordpress_surface():
    ...
    main=(ROOT/'wordpress-plugin/sustainable-catalyst-workbench/sustainable-catalyst-workbench.php').read_text(); assert 'Version: 9.7.0' in main and "define('SCWB_VERSION', '9.7.0');" in main and 'scwb-v960-scientific-results-narrative-synthesis.php' in main
