...
def test_v560_wordpress_contract_and_studio_registration():
    ...
    assert 'Version: 5.6.0' in main or 'Version: 5.7.0' in main or 'Version: 5.8.0' in main or 'Version: 5.9.0' in main or 'Version: 6.0.0' in main or 'Version: 6.0.1' in main or 'Version: 6.1.0' in main or 'Version: 6.2.0' in main
    assert "define('SCWB_VERSION', '5.6.0')" in main or "define('SCWB_VERSION', '5.7.0')" in main or "define('SCWB_VERSION', '5.8.0')" in main or "define('SCWB_VERSION', '5.9.0')" in main or "define('SCWB_VERSION', '6.0.0')" in main or "define('SCWB_VERSION', '6.0.1')" in main or "define('SCWB_VERSION', '6.1.0')" in main or "define('SCWB_VERSION', '6.2.0')" in main
    ...
    assert "const VERSION = '5.6.0'" in primary or "const VERSION = '5.7.0'" in primary or "const VERSION = '5.8.0'" in primary or "const VERSION = '5.9.0'" in primary or "const VERSION = '6.0.0'" in primary or "const VERSION = '6.0.1'" in primary
