...
def test_v570_wordpress_contract_and_studio_registration():
    ...
    assert 'Version: 5.7.0' in main or 'Version: 5.8.0' in main or 'Version: 5.9.0' in main or 'Version: 6.0.0' in main or 'Version: 6.0.1' in main or 'Version: 6.1.0' in main or 'Version: 6.2.0' in main or 'Version: 6.4.0' in main
    assert "define('SCWB_VERSION', '5.7.0')" in main or "define('SCWB_VERSION', '5.8.0')" in main or "define('SCWB_VERSION', '5.9.0')" in main or "define('SCWB_VERSION', '6.0.0')" in main or "define('SCWB_VERSION', '6.0.1')" in main or "define('SCWB_VERSION', '6.1.0')" in main or "define('SCWB_VERSION', '6.2.0')" in main or "define('SCWB_VERSION', '6.4.0')" in main
    ...
    assert "const VERSION = '5.7.0'" in primary or "const VERSION = '5.8.0'" in primary or "const VERSION = '5.9.0'" in primary or "const VERSION = '6.0.0'" in primary or "const VERSION = '6.0.1'" in primary
    assert 'data-scwb-version="5.7.0"' in primary or 'data-scwb-version="5.8.0"' in primary or 'data-scwb-version="5.9.0"' in primary or 'data-scwb-version="6.0.0"' in primary or 'data-scwb-version="6.0.1"' in primary
