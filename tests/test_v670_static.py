...
def test_v670_release_identity_and_router_registration():
    assert 'APP_VERSION = "6.11.0"' in (ROOT/'backend/app/release.py').read_text()
...
def test_v670_wordpress_identity_and_status_bridge():
    ...
    assert 'Version: 6.11.0' in main and "define('SCWB_VERSION', '6.11.0')" in main and 'scwb-v670-computation-execution-lineage.php' in main
