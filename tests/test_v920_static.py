...
def test_v920_backend_registration_and_identity():
    ...
    main=(ROOT/'backend/app/main.py').read_text(); assert 'from app.v920 import router as v920_router' in main and 'version="9.8.0"' in main
...
def test_v920_wordpress_surface_and_version():
    ...
    assert 'Version: 9.8.0' in plugin and "define('SCWB_VERSION', '9.8.0')" in plugin
