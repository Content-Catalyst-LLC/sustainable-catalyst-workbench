...
EXPECTED_SECTIONS = ['identity', 'numeric_registry', 'energy_balance', 'economics', 'bioenergy_and_carbon', 'grid_storage_reliability', 'provenance', 'review']
