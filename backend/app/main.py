...
app = FastAPI(title='Sustainable Catalyst Workbench API', version='1.7.0')
...
@app.get('/')
def root():
    return {"ok": True, "name": "Sustainable Catalyst Workbench API", "version": "1.7.0"}

@app.get('/health')
def health():
    return {"ok": True, "status": "healthy", "version": "1.7.0"}
