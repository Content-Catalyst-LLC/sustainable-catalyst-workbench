...
app = FastAPI(title='Sustainable Catalyst Workbench API', version='0.9.2')
...
@app.get('/')
def root():
    return {"ok": True, "name": "Sustainable Catalyst Workbench API", "version": "0.9.2"}

@app.get('/health')
def health():
    return {"ok": True, "status": "healthy", "version": "0.9.2"}
