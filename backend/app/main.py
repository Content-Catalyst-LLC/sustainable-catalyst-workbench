...
# Static release identity marker: version="10.0.0"
version=APP_VERSION
...
# Workbench v8.1.0 — Research Environment Persistence & Recovery routes.
from app.v810 import router as v810_router
app.include_router(v810_router)


# Workbench v8.3.0 — Unified Research Project Workspace routes.
from app.v820 import router as v820_router
app.include_router(v820_router)


# Workbench v8.3.0 — Research Asset & Artifact Registry routes.
from app.v830 import router as v830_router
app.include_router(v830_router)


# Workbench v8.4.0 — Interactive Execution Console routes.
from app.v840 import router as v840_router
app.include_router(v840_router)

# Workbench v8.5.0 Research Timeline & Run History routes.
from app.v850 import router as v850_router
app.include_router(v850_router)


# Workbench v8.6.0 — Visual Research Canvas routes.
from app.v860 import router as v860_router
app.include_router(v860_router)


# Workbench v8.7.0 — Linked Scientific Views & Cross-Filtering routes.
from app.v870 import router as v870_router
app.include_router(v870_router)


# Workbench v8.8.0 — Comparative Experiment & Model Analysis routes.
from app.v880 import router as v880_router
app.include_router(v880_router)


# Workbench v8.9.0 — Interactive Scientific Figure & Visualization Composer routes.
from app.v890 import router as v890_router
app.include_router(v890_router)


# Workbench v8.10.0 — Reproducible Analysis Board routes.
from app.v8100 import router as v8100_router
app.include_router(v8100_router)


# Workbench v8.12.0 — Research Publication & Evidence Handoff routes.
from app.v8110 import router as v8110_router
app.include_router(v8110_router)


# Workbench v8.12.0 — Unified Workbench Production Certification routes.
from app.v8120 import router as v8120_router
app.include_router(v8120_router)


# Workbench v9.0.0 — Unified Scientific Study Composer routes.
from app.v900 import router as v900_router
app.include_router(v900_router)


# Workbench v9.2.0 — Experimental Design & Research Protocol Builder routes.
from app.v910 import router as v910_router
app.include_router(v910_router)


# Workbench v9.2.0 — Batch Experiment & Computational Campaign Manager routes.
from app.v920 import router as v920_router
app.include_router(v920_router)


# Workbench v9.3.0 — Statistical Analysis & Diagnostic Workspace routes.
from app.v930 import router as v930_router
app.include_router(v930_router)


# Workbench v9.4.0 — Uncertainty & Sensitivity Study Composer routes.
from app.v940 import router as v940_router
app.include_router(v940_router)

# Workbench v9.5.0 — Model Calibration & Parameter Estimation.
from app.v950 import router as v950_router
app.include_router(v950_router)


# Workbench v9.6.0 — Scientific Results & Narrative Synthesis.
from app.v960 import router as v960_router
app.include_router(v960_router)

# Workbench v9.7.0 — Reproduction & Replication Workflow.
from app.v970 import router as v970_router
app.include_router(v970_router)


# Workbench v9.8.0 — Cross-Study Comparison & Meta-Analysis Workspace.
from app.v980 import router as v980_router
app.include_router(v980_router)
...
from app.v9110 import router as v9110_router
app.include_router(v9110_router)


# Workbench v9.12.0 — Workbench v9 Production Certification.
from app.v9120 import router as v9120_router
app.include_router(v9120_router)


# Workbench v10.0.0 — Scientific AI Engineering Runtime Foundation.
from app.v1000 import router as v1000_router
app.include_router(v1000_router)
