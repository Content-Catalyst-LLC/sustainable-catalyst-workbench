...
def capabilities_record() -> dict[str, Any]:
    return {
        ...
        "capabilities": [
            ...
            "unified-computational-research-environment",
            "content-addressed-research-environment-state",
            "explicit-research-surface-planning",
            "reproducible-environment-snapshot-planning",
            "platform-core-research-environment-session-planning",
            "unified-scientific-study-composer",
            "explicit-scientific-study-stage-readiness",
            "content-addressed-scientific-study-records",
            "analysis-snapshot-study-binding",
            "publication-package-study-binding",
            "platform-core-scientific-study-planning",
            "experimental-design-research-protocol-builder",
            "formal-research-protocol-objects",
            "research-protocol-execution-planning",
            "platform-core-research-protocol-planning",
            "batch-experiment-computational-campaign-manager",
            "deterministic-parameter-sweep-campaigns",
            "resumable-computational-campaign-state",
            "execution-console-campaign-job-materialization",
            "platform-core-computational-campaign-planning",
            "statistical-analysis-diagnostic-workspace",
            "statistical-descriptive-and-interval-analysis",
            "statistical-distribution-assumption-diagnostics",
            "explicit-hypothesis-test-statistics",
            "statistical-correlation-regression-diagnostics",
            "content-addressed-statistical-analysis-records",
            "platform-core-statistical-analysis-planning",
            "scientific-ai-engineering-runtime-foundation",
            "content-addressed-ai-engineering-experiments",
            "explicit-ai-model-provider-runtime-contracts",
            "ai-dataset-lineage-bindings",
            "deterministic-ai-training-inference-configurations",
            "ai-resource-budget-contracts",
            "neutral-ai-execution-planning",
            "platform-core-ai-experiment-planning",
        ...
        "coreIntegration": {
            ...
            "unifiedComputationalResearchEnvironment": True,
            "researchEnvironmentSurfacePlanning": True,
            "researchEnvironmentSnapshotPlanning": True,
            "researchEnvironmentCoreSessionPlanning": True,
            "researchEnvironmentPersistenceRecovery": True,
            "researchEnvironmentRevisionHistory": True,
            "researchEnvironmentCheckpoints": True,
            "researchEnvironmentRecovery": True,
            "unifiedResearchProjectWorkspace": True,
            "researchProjectDashboardSummaries": True,
            "researchProjectSurfaceNavigation": True,
            "researchProjectActivityHistory": True,
            "researchProjectCoreSessionPlanning": True,
            "researchAssetArtifactRegistry": True,
            "researchAssetProjectIndexing": True,
            "researchAssetSearch": True,
            "researchAssetRevisionHistory": True,
            "researchAssetCorePlanning": True,
            "interactiveExecutionConsole": True,
            "executionConsoleDurableJobs": True,
            "executionConsoleExplicitDispatch": True,
            "executionConsoleJobComparison": True,
            "executionConsoleCorePlanning": True,
            "researchTimelineRunHistory": True,
            "researchTimelineDerivedEvents": True,
            "researchTimelineLineageGraph": True,
            "researchTimelineComparison": True,
            "researchTimelineCorePlanning": True,
            "visualResearchCanvas": True,
            "visualResearchCanvasPersistentLayout": True,
            "visualResearchCanvasLineageOverlay": True,
            "visualResearchCanvasLinkedSelection": True,
            "visualResearchCanvasCorePlanning": True,
            "linkedScientificViews": True,
            "linkedScientificCrossFiltering": True,
            "linkedScientificSelectionPropagation": True,
            "linkedScientificFacetCounts": True,
            "linkedScientificCorePlanning": True,
            "comparativeExperimentModelAnalysis": True,
            "comparativeRunMetricExtraction": True,
            "comparativePairwiseDeltas": True,
            "comparativeNeutralAssessment": True,
            "comparativeCorePlanning": True,
            "interactiveScientificFigureComposer": True,
            "scientificFigureMultiPanelComposition": True,
            "scientificFigureMetricDataBinding": True,
            "scientificFigureProvenanceManifest": True,
            "scientificFigureLinkedSelection": True,
            "scientificFigureExportPlanning": True,
            "scientificFigureCorePlanning": True,
            "reproducibleAnalysisBoard": True,
            "analysisBoardCrossObjectAssembly": True,
            "analysisBoardImmutableSnapshots": True,
            "analysisBoardProvenance": True,
            "analysisBoardResearcherNarrative": True,
            "analysisBoardCorePlanning": True,
            "researchPublicationEvidenceHandoff": True,
            "publicationHandoffEvidenceManifest": True,
            "publicationHandoffImmutablePackages": True,
            "publicationHandoffMultiDestinationPlanning": True,
            "publicationHandoffCorePlanning": True,
            "publicationHandoffKnowledgeLibraryPlanning": True,
            "publicationHandoffResearchLabPlanning": True,
            "unifiedWorkbenchProductionCertification": True,
            "productionCertificationReleaseIdentity": True,
            "productionCertificationPersistenceReadiness": True,
            "productionCertificationCoreCompatibility": True,
            "productionCertificationPublicationHandoff": True,
            "productionCertificationWordPressIntegrity": True,
            "productionCertificationDeploymentInvariants": True,
            "unifiedScientificStudyComposer": True,
            "scientificStudyStageReadiness": True,
            "scientificStudyContentAddressedRecords": True,
            "scientificStudyAnalysisSnapshotBinding": True,
            "scientificStudyPublicationPackageBinding": True,
            "scientificStudyCorePlanning": True,
            "experimentalDesignResearchProtocolBuilder": True,
            "researchProtocolContentAddressedRecords": True,
            "researchProtocolPreregistrationMetadata": True,
            "researchProtocolExecutionPlanning": True,
            "researchProtocolCorePlanning": True,
            "batchExperimentComputationalCampaignManager": True,
            "computationalCampaignDeterministicSweeps": True,
            "computationalCampaignResumableState": True,
            "computationalCampaignExecutionMaterialization": True,
            "computationalCampaignAnalysisPlanning": True,
            "computationalCampaignCorePlanning": True,
            "statisticalAnalysisDiagnosticWorkspace": True,
            "statisticalAnalysisDescriptiveStatistics": True,
            "statisticalAnalysisDiagnostics": True,
            "statisticalAnalysisHypothesisStatistics": True,
            "statisticalAnalysisRegressionDiagnostics": True,
            "statisticalAnalysisContentAddressedRecords": True,
            "statisticalAnalysisCorePlanning": True,
            "uncertaintySensitivityStudyComposer": True,
            "uncertaintySensitivityMonteCarloSampling": True,
            "uncertaintySensitivityLatinHypercubeSampling": True,
            "uncertaintySensitivitySobolSampling": True,
            "uncertaintySensitivityCampaignAnalysis": True,
            "uncertaintySensitivityContentAddressedStudies": True,
            "uncertaintySensitivityCorePlanning": True,
            "modelCalibrationParameterEstimation": True,
            "modelCalibrationCampaignObjectiveScoring": True,
            "modelCalibrationBoundedEstimation": True,
            "modelCalibrationRobustLoss": True,
            "modelCalibrationIdentifiabilityDiagnostics": True,
            "modelCalibrationContentAddressedRecords": True,
            "modelCalibrationCorePlanning": True,
            "scientificResultsNarrativeSynthesis": True,
            "scientificResultsResearcherAuthoredNarrative": True,
            "scientificResultsSourceBinding": True,
            "scientificResultsStatementTraceability": True,
            "scientificResultsContentAddressedRecords": True,
            "scientificResultsPublicationPlanning": True,
            "scientificResultsCorePlanning": True,
            "reproductionReplicationWorkflow": True,
            "reproductionReplicationTargetBinding": True,
            "reproductionReplicationEnvironmentCapture": True,
            "reproductionReplicationComparisonCriteria": True,
            "reproductionReplicationResultComparison": True,
            "reproductionReplicationContentAddressedRecords": True,
            "reproductionReplicationCorePlanning": True,
            "crossStudyMetaAnalysisWorkspace": True,
            "crossStudyEffectNormalization": True,
            "crossStudyFixedEffectMetaAnalysis": True,
            "crossStudyRandomEffectsMetaAnalysis": True,
            "crossStudyHeterogeneityDiagnostics": True,
            "crossStudySubgroupAnalysis": True,
            "crossStudyLeaveOneOutSensitivity": True,
            "crossStudyCorePlanning": True,
            "researchPackageExchangePortability": True,
            "researchPackageContentAddressedExport": True,
            "researchPackageZipArchiveExport": True,
            "researchPackageIntegrityVerification": True,
            "researchPackageDependencyInventory": True,
            "researchPackageCompatibilityAssessment": True,
            "researchPackageImportStaging": True,
            "researchPackageCorePlanning": True,
            "platformWideScientificResearchHandoff": True,
            "scientificResearchPortableTransportBinding": True,
            "scientificResearchDestinationContracts": True,
            "scientificResearchDestinationReadiness": True,
            "scientificResearchRequirementReporting": True,
            "scientificResearchContentAddressedHandoffs": True,
            "scientificResearchCrossProductPlanning": True,
            "scientificResearchCoreGovernancePlanning": True,
            "endToEndResearchStudyCertification": True,
            "researchStudyCertificationProfiles": True,
            "researchStudyCertificationObjectIntegrity": True,
            "researchStudyCertificationLineageCoherence": True,
            "researchStudyCertificationReproducibilityReadiness": True,
            "researchStudyCertificationPortabilityReadiness": True,
            "researchStudyCertificationHandoffReadiness": True,
            "researchStudyCertificationContentAddressedRecords": True,
            "researchStudyCertificationCorePlanning": True,
            "workbenchV9ProductionCertification": True,
            "v9ProductionCertificationReleaseIdentity": True,
            "v9ProductionCertificationRuntimeReadiness": True,
            "v9ProductionCertificationPersistenceReadiness": True,
            "v9ProductionCertificationRetainedMilestones": True,
            "v9ProductionCertificationPortabilityHandoff": True,
            "v9ProductionCertificationDeploymentInvariants": True,
            "v9ProductionCertificationContentAddressedRecords": True,
            "v9ProductionCertificationCorePlanning": True,
            "scientificAIEngineeringRuntimeFoundation": True,
            "aiEngineeringContentAddressedExperiments": True,
            "aiEngineeringModelProviderContracts": True,
            "aiEngineeringDatasetLineage": True,
            "aiEngineeringDeterministicConfiguration": True,
            "aiEngineeringResourceBudgets": True,
            "aiEngineeringNeutralExecutionPlanning": True,
            "aiEngineeringCorePlanning": True,
