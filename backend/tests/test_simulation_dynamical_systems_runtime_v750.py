...
def test_manifest_catalog_status_and_capabilities():
    ...
    d=m.json(); assert d['schema']==SCHEMA and d['version']=='7.11.0' and len(d['simulationKinds'])==4
    ...
    caps=c.get('/capabilities').json(); assert caps['version']=='7.11.0' and caps['coreIntegration']['simulationDynamicalSystemsRuntime'] is True
