...
def package_spec():
    ...
    return {
        ...
        "environments":[{"environmentKey":"workbench","environmentType":"workbench","environmentRef":"sc://workbench/runtime/9.6.0","versionRef":"9.12.0"}],
...
def test_manifest_status():
    m=c.get('/repro-package/manifest').json(); assert m['ok'] and m['version']=='9.12.0' and m['coreContract']=='sc.research.reproducible-package.v1'
