...
def package_spec():
    ...
    return {
        ...
        "environments":[{"environmentKey":"workbench","environmentType":"workbench","environmentRef":"sc://workbench/runtime/8.9.0","versionRef":"8.9.0"}],
...
def test_manifest_status():
    m=c.get('/repro-package/manifest').json(); assert m['ok'] and m['version']=='8.9.0' and m['coreContract']=='sc.research.reproducible-package.v1'
