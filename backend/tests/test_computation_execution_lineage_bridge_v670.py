...
def sample_components():
    return ExecutionComponentsRequest(
        ...
        environments=[EnvironmentItem(environmentKey="env-1", runtimeVersion="6.10.0", packages=["numpy==2.x"], environmentHash="sha256:env")],
        steps=[
...
def test_v670_status_and_capabilities():
    ...
    assert status["ok"] is True and status["version"] == "6.10.0"
