...
echo "Testing Sustainable Catalyst Workbench v3.7.0"
grep -q 'Version: 3.7.0' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q "define('SCWB_VERSION', '3.7.0')" "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'version="3.7.0"' "$ROOT/backend/app/main.py"
...
php "$ROOT/tests/test_v370_plugin_activation.php"
...
echo "Workbench v3.7.0 release checks passed."
