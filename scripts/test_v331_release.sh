...
echo "Testing Sustainable Catalyst Workbench v3.3.1"
grep -q 'Version: 3.3.1' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q "define('SCWB_VERSION', '3.3.1')" "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'version="3.3.1"' "$ROOT/backend/app/main.py"
...
php "$ROOT/tests/test_v331_plugin_activation.php"
...
echo "Workbench v3.3.1 release checks passed."
