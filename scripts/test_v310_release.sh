...
echo "Testing Sustainable Catalyst Workbench v3.1.0"
grep -q 'Version: 3.1.0' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q "define('SCWB_VERSION', '3.1.0')" "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'scwb-v310-persistent-project-workspace.php' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'from app.v310 import router as v310_router' "$ROOT/backend/app/main.py"
grep -q 'version="3.1.0"' "$ROOT/backend/app/main.py"
grep -q "'projects' => array" "$PLUGIN/includes/scwb-v301-production-reliability.php"
grep -q "'projects'" "$PLUGIN/assets/js/scwb-primary-repair.js"
...
echo "Workbench v3.1.0 release checks passed."
