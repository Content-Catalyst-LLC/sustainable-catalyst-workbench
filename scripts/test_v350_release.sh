...
echo "Testing Sustainable Catalyst Workbench v3.5.0"
grep -q 'Version: 3.5.0' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q "define('SCWB_VERSION', '3.5.0')" "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'version="3.5.0"' "$ROOT/backend/app/main.py"
...
php "$ROOT/tests/test_v350_plugin_activation.php"
...
echo "Workbench v3.5.0 release checks passed."
