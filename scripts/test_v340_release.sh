...
echo "Testing Sustainable Catalyst Workbench v3.4.0"
grep -q 'Version: 3.4.0' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q "define('SCWB_VERSION', '3.4.0')" "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'version="3.4.0"' "$ROOT/backend/app/main.py"
...
php "$ROOT/tests/test_v340_plugin_activation.php"
php "$ROOT/tests/test_v340_wordpress_runtime.php"
...
echo "Workbench v3.4.0 release checks passed."
