...
echo "Testing Sustainable Catalyst Workbench v3.2.0"
grep -q 'Version: 3.2.0' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q "define('SCWB_VERSION', '3.2.0')" "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'scwb-v320-knowledge-library-integration.php' "$PLUGIN/sustainable-catalyst-workbench.php"
grep -q 'from app.v320 import router as v320_router' "$ROOT/backend/app/main.py"
grep -q 'version="3.2.0"' "$ROOT/backend/app/main.py"
grep -q "'library' => array" "$PLUGIN/includes/scwb-v301-production-reliability.php"
grep -q "'library'" "$PLUGIN/assets/js/scwb-primary-repair.js"
...
php "$ROOT/tests/test_v320_plugin_activation.php"
php "$ROOT/tests/test_v320_wordpress_runtime.php"
php "$ROOT/tests/test_v310_plugin_activation.php"
...
echo "Workbench v3.2.0 release checks passed."
